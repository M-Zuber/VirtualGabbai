...
CREATE TABLE IF NOT EXISTS `zera_levi`.`t_yarthziehts` (
    ...
    CONSTRAINT `fk_yarthziehts_people1` FOREIGN KEY (`person_id`)
...
CREATE TABLE IF NOT EXISTS `zera_levi`.`t_accounts` (
    ...
    CONSTRAINT `fk_accounts_people1` FOREIGN KEY (`person_id`)
        REFERENCES `zera_levi`.`t_people` (`_id`)
        ON DELETE CASCADE ON UPDATE CASCADE
)  ENGINE=InnoDB;
...
CREATE TABLE IF NOT EXISTS `zera_levi`.`t_donations` (
    ...
    CONSTRAINT `fk_donations_accounts` FOREIGN KEY (`account_id`)
...
CREATE TABLE IF NOT EXISTS `zera_levi`.`t_phone_numbers` (
    ...
    PRIMARY KEY (`_id`),
    CONSTRAINT `fk_phone_numbers_people1` FOREIGN KEY (`person_id`)
        REFERENCES `zera_levi`.`t_people` (`_id`)
        ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT `fk_phone_numbers_phone_types1` FOREIGN KEY (`number_type`)
...
CREATE TABLE IF NOT EXISTS `zera_levi`.`t_users` (
    ...
    CONSTRAINT `fk_users_privilege_groups1` FOREIGN KEY (`privileges_group`)
